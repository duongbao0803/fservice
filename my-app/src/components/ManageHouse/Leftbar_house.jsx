    ...
    <div className="left-bar">
      ...
      <div className="main_info-list">
        <div className="user info-buiding">
          <span><i className="fa-solid fa-building"></i>&nbsp;&nbsp;Căn hộ của bạn</span>
        </div>
        <div className="user info-package">
          <span><i className="fa-solid fa-box-archive"></i>&nbsp;&nbsp;Gói dịch vụ</span>
        </div>
        <div className="user info-order">
          <span><i className="fa-regular fa-file"></i>&nbsp;&nbsp;Quản lí đơn hàng</span>
        </div>
        <div className="user info-account">
          <span className=""><i className="fa-regular fa-user"></i>&nbsp;&nbsp;Thông tin tài khoản</span>
        </div>
        <div className="user logout">
          <span><i className="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp;Thoát</span>
        </div>
      </div>
    </div>
  );
